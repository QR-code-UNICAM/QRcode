...
export const constantRoutes = [
  ...
  // },
  {
    path: '/qrcode',
    name: 'qrcode',
    component: (resolve) => require(['@/views/qrcode/index'], resolve),
    hidden: true
  },
  {
    path: '/codehistory',
    component: (resolve) => require(['@/views/qrcode/codehistory'], resolve),
    hidden: true
  },
  {
    path: '/login',
...

  {
    ...
    children: [{
        ...
        component: (resolve) => require(['@/views/qrcode/index'], resolve),
        name: 'QRCODE首页',
        meta: {title: 'QRCODE首页', icon: 'dashboard', affix: true}
      }
    ]
  },
  {
